...
for diff in ["Easy", "Normal", "Hard"]:
    ...
    marker = " 👑" if diff == difficulty else ""
    st.sidebar.caption(f"{diff}: {best}{marker}")
...
if submit:
    ...
    if not ok:
        ...
        # FIX (Bug 2): AI identified even-attempt string cast causing lexicographic comparisons (e.g. "9" > "65"); collaborated with AI to always pass secret as int
